...
NOTE: really old (from August 2025)
...
By default it will save the level to `%AppData%/Godot/app_userdata/Barfy's Adventure/levels/wau express bf output.json` (so a level called `wau express bf output` in your levels list) (or in `/home/$USER/.local/share/Godot/...` on Linux). If you want to save the level JSON elsewhere (or you don't have the game installed...), you can use the `--out` argument to put it elsewhere.
